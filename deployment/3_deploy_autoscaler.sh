...
HUB_ROLE=$(eksctl utils describe-stacks --name pangeo-csiro | grep eksctl-pangeo-csiro-nodegroup-hub-NodeInstanceRole --color=never | cut -d'/' -f2 | tr -d '"')
